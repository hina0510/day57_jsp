...
<body>
	...
	<form action="modify.jsp" method="post">
		<input type="hidden" name="id2" value="${dto.id }">
		<table border="1">
			<tr>
				<th>번호</th><td><input type="text" readonly name="id" value="${dto.id }"></td>
			</tr>
			<tr>
			...
			<tr>
				<th>내용</th><td><textarea name="content">${dto.content }</textarea></td>
			</tr>
			<tr>
				<td colspan="2">
				<input type="submit" value="수정">
				<a href="list.jsp">목록이동</a>
				<a href="reply_view.jsp?id=${dto.id }&name=${dto.name }&title=${dto.title }">답변</a>
